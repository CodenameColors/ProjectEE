  ...
  public class ResizeRotateAdorner : Adorner
  {
        ...
        : base(designerItem)
    {
        ...
        this.visuals.Add(this.chrome);
			...
			MouseUp += ResizeRotateAdorner_MouseUp;
    }

		private void ResizeRotateAdorner_MouseUp(object sender, System.Windows.Input.MouseButtonEventArgs e)
		{
			System.Console.WriteLine("MUP");
		}
