...
{
	public class EngineTextBlock : BaseTextBlock
	{
		#region Delegates
		...
		#region Contructors
		public EngineTextBlock(string UIName, int xPos, int yPos, int width, int height, int zindex, bool border, int xOff, int yOff, string text, float textTime, string backColor, string backImage) : base(UIName, xPos, yPos, width, height, zindex, border, xOff, yOff, text, textTime, backColor, backImage)
		{
		}
		#endregion
