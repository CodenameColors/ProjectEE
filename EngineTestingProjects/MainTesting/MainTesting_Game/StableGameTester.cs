...
namespace Game1
{
    ...
    /// </summary>
    public class StableGameTester : Game
    {
		...
		protected override void LoadContent()
		{
			...
			testTexture = Content.Load<Texture2D>("Images/source/CraftingEquation");
		...
		protected override void Draw(GameTime gameTime)
		{
			...
			spriteBatch.Draw(testTexture, new Rectangle(0, 0, 200, 200), Color.White) ;
